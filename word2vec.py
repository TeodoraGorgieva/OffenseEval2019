...
if __name__ == '__main__':
    ...
    train_matrix = word2vec_matrix(train['tweet'].values.astype('U'), 2)
    train_vectors = create_doc_vector(train['tweet'].values.astype('U'), train_matrix)
    test_matrix = word2vec_matrix(test['tweet'].values.astype('U'), 2)
    test_vectors = create_doc_vector(test['tweet'].values.astype('U'), test_matrix)
