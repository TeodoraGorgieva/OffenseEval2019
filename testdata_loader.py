...
if __name__ == "__main__":
    ...
    testsetA = pd.merge(left=testdataA, right=labelsA, left_on='id', right_on='id')
    testdataA.to_csv('test_taskA.csv', encoding='utf-8')
    ...
    testdataB.to_csv('test_taskB.csv', encoding='utf-8')
    ...
    testdataC.to_csv('test_taskC.csv', encoding='utf-8')
